...
class weixianjiashi(models.Model):
    ...
    Alcohol = models.CharField(max_length=30, null=True, blank=True)
    # 审判结果
    # 主刑
    ...
    # AmountOfCompensation = models.CharField(max_length=30, null=True, blank=True)
    # VictimUnderstanding = models.CharField(max_length=3, null=True, blank=True)
    # confirmationOfResponsibility = models.CharField(max_length=4, null=True, blank=True)
